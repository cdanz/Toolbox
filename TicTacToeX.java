...
public class TicTacToeX {
	private static int dim; //Dimensions of the game board
	private static int max = dim * dim; //Max number of turns a game 
											//can have
	...
	/**
	 * Constructor - fills a 2D array with spaces to start. Array is 
	 * of the size dictated by user.
	 * param d				Dimensions of your board
	 */
	public TicTacToeX(int d) {
		dim = d;
