...
/**
 * This is an edited version of the given WordCounter driver class. Adjusted
 * so that you can use some new extra credit features and not require a 
 * table size from the user. 
 * @author danzc
 */
public class P3 {
    //@formatter:off
...
"load <file-name>   \n"+
"           Creates a Hash Table and reads the words from the file, \n" + 
"           counting the occurrences of each word to be analyzed later.\n\n" +
...
"quit       Exits the program.";
    ...
    private static void removeCommonWordsFrom(WordCounter wordCounter) {
        for (String word : CommonWordList.getWords()) {
        		...
        		if (wordCounter.needResize())
        			wordCounter.dynamicResize();
        }
    }
    ...
    private static void debugCmd(Scanner lineScanner,
        ...
        if (lineScanner.hasNextInt()) {
            ...
            if (0 <= id && id < loadedPassages.size()) {
                ...
                System.out.println(pe.wordCounter.getCapacity());
            } else {
